        ...
        child: BlocConsumer < CoronaBloc, CoronaState > (
          ...
          builder: (context, state) {
              ...
              return Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      Image.asset('img/friends.png', fit: BoxFit.cover,),
            ...
            if (state is CoronaLoaded) {
              ...
              print(dataMap);
              double sum = dataMap['Recovered'] + dataMap['Ongoing'] + dataMap['Death'];
              return Scaffold(
                body: SizedBox.expand(
                  child: PageView(
                    ...
                    children: < Widget > [
                      HomeScreen(dataMap: dataMap, data: data, sum: sum, refreshCompleter: _refreshCompleter),
              ...
              return Container(
                ...
                child: Center(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: <Widget>[
                      Image.asset('img/home_cinema.png', fit: BoxFit.cover,),
