                    ...
                    children: < Widget > [
                      Container(
                        decoration: BoxDecoration(
                          color: d == 'Death' ? Colors.orangeAccent[400] : d == 'Recovered' ? Colors.blue[300] : Colors.blue[900],
                      ...
                      Column(
                        ...
                        children: < Widget > [
                          SizedBox(height: 15, ),
                          Text(d, style: TextStyle(color: Colors.grey[400], fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(24))),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: < Widget > [
                          Row(
                            children: < Widget > [
                              ClipRRect(borderRadius: BorderRadius.circular(20), child: Container(color: Colors.red[700], width: 10, height: 10, )),
                              SizedBox(width: 5, ),
                              Text('Confirmed', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w600)),
                            ]
                          ),
                          SizedBox(height: 10, ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: < Widget > [
                          Row(
                            children: < Widget > [
                              ClipRRect(borderRadius: BorderRadius.circular(20), child: Container(color: Colors.blue[300], width: 10, height: 10, )),
                              SizedBox(width: 5, ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: < Widget > [
                          Row(
                            children: < Widget > [
                              ClipRRect(borderRadius: BorderRadius.circular(20), child: Container(color: Colors.orangeAccent[400], width: 10, height: 10, )),
                              SizedBox(width: 5, ),
